...
const STT_CUSTOMIZATION_ID = process.env.STT_CUSTOMIZATION_ID || '';

// ユーザー定義の環境変数から Watson Text to Speech CUSTOMIZATION_ID を取得する。(未設定 = 空文字)
const TTS_CUSTOMIZATION_ID = process.env.TTS_CUSTOMIZATION_ID || '';
...
module.exports = {
    ...
    "STT_CUSTOMIZATION_ID": STT_CUSTOMIZATION_ID,
    "TTS_CUSTOMIZATION_ID": TTS_CUSTOMIZATION_ID,
    "DB_NAME": DB_NAME,
