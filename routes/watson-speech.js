...
router.get('/', (req, res) => {
    token(context.sttCreds, (sttResult) => {
        if (sttResult) {
            ...
            if (context.STT_CUSTOMIZATION_ID) {
                sttValue.customization_id = context.STT_CUSTOMIZATION_ID;
            }
            ...
            token(context.ttsCreds, (ttsResult) => {
                if (ttsResult) {
                    ...
                    if (context.TTS_CUSTOMIZATION_ID) {
                        watsonSpeechContext.tts.customization_id = context.TTS_CUSTOMIZATION_ID;
                    }
